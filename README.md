...
4. Color bitdepth is lower than luminance even though the name of the codec ProRes444. "4:4:4" commonly means sample ratios between components implying equal distribution of storage space, but it would seem this is not the case with ProRes.
